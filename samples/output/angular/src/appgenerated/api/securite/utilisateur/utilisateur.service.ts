...
export class UtilisateurService {
    ...
    /**
     * @description Download de la photo d'un utilisateur
     * @param utiId Id de l'utilisateur
     * @returns Fichier de la photo
     */
    downloadPicture(utiId: number, options: {headers?: HttpHeaders | {[header: string]: string | string[]}; context?: HttpContext; params?: HttpParams | {[param: string]: string | number | boolean | ReadonlyArray<string | number | boolean>}; withCredentials?: boolean; reportProgress?: boolean; transferCache?: {includeHeaders?: string[]} | boolean} = {}): Observable<Blob> {
        return this.http.get(`/api/utilisateurs/${utiId}/picture`, {responseType: "blob", observe: 'body', ...options});
    }
    ...
    /**
     * @description Upload de la photo d'un utilisateur
     * @param utiId Id de l'utilisateur
     * @param file Fichier de la photo
     */
    uploadPicture(utiId: number, file: File, options: {headers?: HttpHeaders | {[header: string]: string | string[]}; context?: HttpContext; params?: HttpParams | {[param: string]: string | number | boolean | ReadonlyArray<string | number | boolean>}; withCredentials?: boolean; reportProgress?: boolean; transferCache?: {includeHeaders?: string[]} | boolean} = {}): Observable<void> {
        ...
        return this.http.post<void>(`/api/utilisateurs/${utiId}/picture`, body, {observe: 'body', ...options});
    }
