...
export class UtilisateurService {
  ...
  downloadPicture(
    ...
    return this.http.get(`/api/utilisateurs/${utiId}/picture`, {
      responseType: 'blob',
      observe: 'response',
      ...options,
    });
  ...
  searchUtilisateur(
    ...
    return this.http.get<UtilisateurItem[]>(`/api/utilisateurs`, {
      observe: 'body',
      ...options,
    });
  }
  ...
  updateUtilisateur(
    ...
    return this.http.put<UtilisateurRead>(
      `/api/utilisateurs/${utiId}`,
      utilisateur,
  ...
  uploadPicture(
    ...
    return this.http.post<void>(`/api/utilisateurs/${utiId}/picture`, body, {
      observe: 'body',
      ...options,
    });
  }
