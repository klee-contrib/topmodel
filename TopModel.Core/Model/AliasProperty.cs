...
#nullable enable
    ...
    public bool AutoGeneratedValue => !PreservePrimaryKey && Domain?.GeneratedValue != null;

    public GeneratedValueDefinition? GeneratedValue =>
        !PreservePrimaryKey && this.Association == null ? Domain?.GeneratedValue : null;
