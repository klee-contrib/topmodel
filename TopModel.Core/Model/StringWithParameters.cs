        ...
        : base(value)
    {
        ...
        Parameters = regex.Matches(Value).Cast<Match>()
            .Select(match =>
            {
                ...
                {
                    Start = new Mark(Location.Start.Index, Location.Start.Line, Location.Start.Column + match.Index + 1),
                    End = new Mark(Location.Start.Index, Location.Start.Line, Location.Start.Column + match.Index + 1 + refName.Length),
