...
- **[Un domaine](/model/domains)** : Types métier réutilisables avec leurs représentations par langage
- **[Une classe](/model/classes)** : Entités métier, DTOs, classes persistées ou non
- **[Un endpoint](/model/endpoints)** : Définition des API REST
- **[Un décorateur](/model/decorators)** : Métadonnées réutilisables
- **[Un convertisseur](/model/mappers#converters)** : Transformations de types
- **[Un flux de données](/model/dataFlows)** : Définition des flux de traitement
