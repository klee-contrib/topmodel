...
class:
  ...
  trigram: UTI # Trigramme de la classe, pour préfixer les propriétés dans la base de données.
...
```yaml title="Utilisateur.tmd" showLineNumbers
---
module: Users # Module commun de toutes classes du fichier
tags: []
---
...
Aller plus loin dans la documentation complète de [classes](/model/classes)
...
public class Utilisateur {
  ...
  */
 @Column(name = "UTI_NOM", length = 100, columnDefinition = "varchar")
 private String nom;

 /**
  * Date d'inscription.
  */
 @Column(name = "UTI_DATE_INSCRIPTION", columnDefinition = "date")
 ...
 **/
create sequence SEQ_UTILISATEUR as int with start 1000 increment by 50 owned by UTILISATEUR.UTI_ID;
```
