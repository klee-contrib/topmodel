...
> Comme il existe plusieurs modes de génération pour les classes contenant des valeurs, les associations avec ces classes aussi sont impactées en conséquences. Plus d'informations dans la documentation des [classes](/model/classes)
