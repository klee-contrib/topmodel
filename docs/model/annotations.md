...
Comme pour les domaines et les décorateurs, il est possible d'utiliser du [templating](/model/templating.md) dans les annotations, et de définir des paramètres :
