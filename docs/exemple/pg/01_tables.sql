 ...
 **/
create table PROFIL (
	PRO_ID int8 generated by default as identity (start with 1000increment 50) not null,
	CODE varchar(3),
...
create table SECTEUR (
	SEC_ID int8 generated by default as identity (start with 1000increment 50) not null,
	PRO_ID int8,
...
create table UTILISATEUR (
	...
	UTI_ID int8 generated by default as identity (start with 1000increment 50) not null,
