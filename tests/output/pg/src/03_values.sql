...
INSERT INTO LIEU(LIE_ID, LIE_NOM, LIE_ADRESSE, LIE_DISCRIMINATOR, RES_TELEPHONE, RES_DATE_CREATION, FRN_TELEPHONE, FRN_BIO) VALUES(1, 'Burger King', NULL, 'RESTAURANT', NULL, '1954-01-01', NULL, NULL);
...
INSERT INTO PERSONNE(PER_ID, PER_NOM, PER_PRENOM, DEP_CODE, PER_DATE_CREATION) VALUES(1, 'Michel', 'Jean', NULL, '2026-01-01');
INSERT INTO PERSONNE(PER_ID, PER_NOM, PER_PRENOM, DEP_CODE, PER_DATE_CREATION) VALUES(2, 'Christophe', 'Michel', NULL, '2026-01-01');

/**		Initialisation de la table EMPLOYE		**/
INSERT INTO EMPLOYE(EMP_TELEPHONE, EMP_DATE_NAISSANCE, EMP_MATRICULE, EMP_DATE_EMBAUCHE, EMP_SALAIRE, LIE_ID, PER_ID) VALUES(NULL, NULL, '123456', '2026-01-01', NULL, 1, 2);
