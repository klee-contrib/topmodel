...
COMMENT ON COLUMN RESTAURANT.RES_ID IS 'Identifiant du restaurant';
COMMENT ON COLUMN RESTAURANT.RES_NOM IS 'Nom du restaurant';
COMMENT ON COLUMN RESTAURANT.RES_ADRESSE IS 'Adresse du restaurant';
