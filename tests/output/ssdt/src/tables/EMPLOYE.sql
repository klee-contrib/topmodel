...
create table EMPLOYE (
	...
	constraint FK_EMPLOYE_LIE_ID foreign key (LIE_ID) references LIEU (LIE_ID),
	constraint FK_EMPLOYE_PER_ID foreign key (PER_ID) references PERSONNE (PER_ID),
