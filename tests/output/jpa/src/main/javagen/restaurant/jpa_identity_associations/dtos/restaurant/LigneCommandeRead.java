...
import restaurant.jpa_identity_associations.entities.restaurant.LigneCommande;
...
public class LigneCommandeRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.LigneCommande#getId() LigneCommande#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Quantité commandée.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.LigneCommande#getQuantite() LigneCommande#getQuantite()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.LigneCommande#getPrixUnitaire() LigneCommande#getPrixUnitaire()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.LigneCommande#getPrixTotal() LigneCommande#getPrixTotal()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.LigneCommande#getCommande() LigneCommande#getCommande()}
	 */
	@NotNull
	...
	/**
	 * Plat commandé.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.LigneCommande#getPlat() LigneCommande#getPlat()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.LigneCommandeRead LigneCommandeRead}.
	 */
	public enum Fields {
		ID(Integer.class),
