...
public class MenuComplet implements Serializable {
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.MenuComplet MenuComplet}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
