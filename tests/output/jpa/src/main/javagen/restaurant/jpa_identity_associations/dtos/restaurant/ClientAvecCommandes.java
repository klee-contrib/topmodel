...
public class ClientAvecCommandes implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Client#getAvisClientsClient() Client#getAvisClientsClient()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Client#getReservationsClient() Client#getReservationsClient()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.ClientAvecCommandes ClientAvecCommandes}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
