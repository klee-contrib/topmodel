...
public class Client {
	...
	/**
	 * Add a value to {@link restaurant.jpa_identity_associations.entities.restaurant.Client#commandes commandes}.
	...
	/**
	 * Add a value to {@link restaurant.jpa_identity_associations.entities.restaurant.Client#avisClientsClient avisClientsClient}.
	...
	/**
	 * Add a value to {@link restaurant.jpa_identity_associations.entities.restaurant.Client#reservationsClient reservationsClient}.
	...
	/**
	 * Remove a value from {@link restaurant.jpa_identity_associations.entities.restaurant.Client#commandes commandes}.
	...
	/**
	 * Remove a value from {@link restaurant.jpa_identity_associations.entities.restaurant.Client#avisClientsClient avisClientsClient}.
	...
	/**
	 * Remove a value from {@link restaurant.jpa_identity_associations.entities.restaurant.Client#reservationsClient reservationsClient}.
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.entities.restaurant.Client Client}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
