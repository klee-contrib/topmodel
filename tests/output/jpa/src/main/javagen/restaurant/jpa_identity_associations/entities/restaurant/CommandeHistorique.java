...
public class CommandeHistorique {
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Commande#getAvisClient() Commande#getAvisClient()}
	 */
	...
	/**
	 * Add a value to {@link restaurant.jpa_identity_associations.entities.restaurant.CommandeHistorique#lignes lignes}.
	...
	/**
	 * Remove a value from {@link restaurant.jpa_identity_associations.entities.restaurant.CommandeHistorique#lignes lignes}.
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.entities.restaurant.CommandeHistorique CommandeHistorique}.
	 */
	public enum Fields {
		ID(Integer.class),
