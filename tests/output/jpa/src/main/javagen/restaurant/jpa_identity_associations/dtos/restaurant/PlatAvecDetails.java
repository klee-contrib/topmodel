...
import restaurant.jpa_identity_associations.entities.restaurant.Plat;
...
/**
 * Plat avec ses détails et sa catégorie.
 */
@Generated("TopModel : https://github.com/klee-contrib/topmodel")
public class PlatAvecDetails implements Serializable {
	...
	/**
	 * Identifiant du plat.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Plat#getId() Plat#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Nom du plat.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Plat#getNom() Plat#getNom()}
	 */
	@NotNull
	@Size(max = 100)
	private String nom;
	...
	/**
	 * Description du plat.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Plat#getDescription() Plat#getDescription()}
	 */
	@Size(max = 100)
	...
	/**
	 * Prix du plat.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Plat#getPrix() Plat#getPrix()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Plat#getDisponible() Plat#getDisponible()}
	 */
	@NotNull
	...
	/**
	 * Catégorie du plat.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Plat#getCategoriePlatCategoriePlat() Plat#getCategoriePlatCategoriePlat()}
	 */
	@NotNull
	private CategoriePlatCode categoriePlatCodeCategoriePlat;

	/**
	 * Restaurant proposant ce plat.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Plat#getRestaurantRestaurant() Plat#getRestaurantRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Plat#getMenuPlatsPlat() Plat#getMenuPlatsPlat()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Plat#getPromotionPlatsPlat() Plat#getPromotionPlatsPlat()}
	 */
	@NotNull
	 ...
	 *
	 * @return Une nouvelle instance de 'PlatAvecDetails'.
	 */
	public PlatAvecDetails(Plat plat) {
		RestaurantMappers.mapPlatAvecDetails(plat, this);
	}
	 ...
	 */
	public CategoriePlatCode getCategoriePlatCodeCategoriePlat() {
	 ...
	 */
	public void setCategoriePlatCodeCategoriePlat(CategoriePlatCode categoriePlatCodeCategoriePlat) {
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.PlatAvecDetails PlatAvecDetails}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
		...
		CATEGORIE_PLAT_CODE_CATEGORIE_PLAT(CategoriePlatCode.class),
