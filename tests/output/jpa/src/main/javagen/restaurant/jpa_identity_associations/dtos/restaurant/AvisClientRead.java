...
public class AvisClientRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.AvisClient#getId() AvisClient#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Date de l'avis.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.AvisClient#getDateAvis() AvisClient#getDateAvis()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.AvisClient#getNombreVues() AvisClient#getNombreVues()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.AvisClientRead AvisClientRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOTE(Integer.class),
