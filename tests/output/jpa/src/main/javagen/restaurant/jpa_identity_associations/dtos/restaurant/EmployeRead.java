...
public class EmployeRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Employe#getTelephone() Employe#getTelephone()}
	 */
	@Size(max = 20)
	...
	/**
	 * Date de naissance.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Employe#getDateNaissance() Employe#getDateNaissance()}
	 */
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Employe#getRestaurant() Employe#getRestaurant()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.EmployeRead EmployeRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
