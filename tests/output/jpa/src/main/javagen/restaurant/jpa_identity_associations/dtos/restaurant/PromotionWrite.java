...
import restaurant.jpa_identity_associations.entities.restaurant.Promotion;
...
public class PromotionWrite implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Promotion#getLibelle() Promotion#getLibelle()}
	 */
	@NotNull
	@Size(max = 100)
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Promotion#getPourcentageReduction() Promotion#getPourcentageReduction()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Promotion#getDateDebut() Promotion#getDateDebut()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Promotion#getDateFin() Promotion#getDateFin()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Promotion#getActive() Promotion#getActive()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Promotion#getRestaurantRestaurant() Promotion#getRestaurantRestaurant()}
	 */
	private Integer restaurantIdRestaurant;

	/**
	 * Association réciproque de PromotionPlat.PromotionIdPromotion.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Promotion#getPromotionPlatsPromotion() Promotion#getPromotionPlatsPromotion()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.PromotionWrite PromotionWrite}.
	 */
	public enum Fields {
