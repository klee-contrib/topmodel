...
/**
 * Commande avec informations d'audit.
 */
@Generated("TopModel : https://github.com/klee-contrib/topmodel")
public class CommandeAuditee implements Serializable {
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.CommandeAuditee CommandeAuditee}.
	 */
	public enum Fields {
		ID(Integer.class),
