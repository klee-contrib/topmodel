...
public class TableClientRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.TableClient#getId() TableClient#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.TableClientRead TableClientRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NUMERO(String.class),
