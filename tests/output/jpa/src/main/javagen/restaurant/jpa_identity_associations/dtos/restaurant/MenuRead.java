...
import restaurant.jpa_identity_associations.entities.restaurant.Menu;
...
public class MenuRead implements Serializable {
	...
	/**
	 * Identifiant du menu.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Menu#getId() Menu#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Nom du menu.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Menu#getNom() Menu#getNom()}
	 */
	@NotNull
	@Size(max = 100)
	private String nom;
	...
	/**
	 * Description du menu.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Menu#getDescription() Menu#getDescription()}
	 */
	@Size(max = 100)
	...
	/**
	 * Prix du menu.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Menu#getPrix() Menu#getPrix()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Menu#getDisponible() Menu#getDisponible()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Menu#getDateDebut() Menu#getDateDebut()}
	 */
	private LocalDateTime dateDebut;

	/**
	 * Date de fin de validité du menu.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Menu#getDateFin() Menu#getDateFin()}
	 */
	private LocalDateTime dateFin;

	/**
	 * Restaurant proposant ce menu.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Menu#getRestaurantRestaurant() Menu#getRestaurantRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.Menu#getMenuPlatsMenu() Menu#getMenuPlatsMenu()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.MenuRead MenuRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
