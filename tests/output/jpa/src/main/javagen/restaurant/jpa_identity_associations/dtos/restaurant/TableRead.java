...
import restaurant.jpa_identity_associations.entities.restaurant.TableRestaurant;
...
public class TableRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.TableRestaurant#getId() TableRestaurant#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Numéro de la table.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.TableRestaurant#getNumero() TableRestaurant#getNumero()}
	 */
	@NotNull
	@Size(max = 10)
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.TableRestaurant#getCapacite() TableRestaurant#getCapacite()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.TableRestaurant#getDisponible() TableRestaurant#getDisponible()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.TableRestaurant#getRestaurant() TableRestaurant#getRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.TableRestaurant#getCommandes() TableRestaurant#getCommandes()}
	 */
	private List<Integer> commandes;

	/**
	 * Association réciproque de Reservation.TableId.
	 * Alias of {@link restaurant.jpa_identity_associations.entities.restaurant.TableRestaurant#getReservations() TableRestaurant#getReservations()}
	 */
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_associations.dtos.restaurant.TableRead TableRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NUMERO(String.class),
