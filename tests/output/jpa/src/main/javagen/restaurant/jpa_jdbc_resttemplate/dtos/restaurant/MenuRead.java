...
public class MenuRead implements Serializable {
	...
	/**
	 * Identifiant du menu.
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Menu#getId() Menu#getId()}
	 */
	@NotNull
	@Column("men_id")
	private Integer id;
	...
	/**
	 * Nom du menu.
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Menu#getNom() Menu#getNom()}
	 */
	@NotNull
	@Size(max = 100)
	@Column("men_nom")
	...
	/**
	 * Description du menu.
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Menu#getDescription() Menu#getDescription()}
	 */
	@Size(max = 100)
	...
	/**
	 * Prix du menu.
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Menu#getPrix() Menu#getPrix()}
	 */
	@NotNull
	@Column("men_prix")
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Menu#getDisponible() Menu#getDisponible()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Menu#getDateDebut() Menu#getDateDebut()}
	 */
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Menu#getDateFin() Menu#getDateFin()}
	 */
	@Column("men_date_fin")
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Menu#getRestaurant() Menu#getRestaurant()}
	 */
	@NotNull
	@Column("lie_id")
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Menu#getDateCreation() Menu#getDateCreation()}
	 */
	@NotNull
	@PastOrPresent
