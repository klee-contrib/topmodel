...
public class RestaurantAvecStatistiques implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Lieu#getId() Lieu#getId()}
	 */
	@NotNull
	@Column("lie_id")
	private Integer id;
	...
	/**
	 * Nom du restaurant.
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Lieu#getNom() Lieu#getNom()}
	 */
	@NotNull
	@Size(max = 100)
	@Column("lie_nom")
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Lieu#getAdresse() Lieu#getAdresse()}
	 */
	@Size(max = 100)
	@Column("lie_adresse")
	...
	/**
	 * Numéro de téléphone.
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Restaurant#getTelephone() Restaurant#getTelephone()}
	 */
	@Size(max = 20)
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Restaurant#getMenus() Restaurant#getMenus()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Restaurant#getPlats() Restaurant#getPlats()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Restaurant#getPromotions() Restaurant#getPromotions()}
	 */
	private List<Integer> promotions;

	/**
	 * Association réciproque de AvisClient.Restaurant.
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Restaurant#getAvisClients() Restaurant#getAvisClients()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Restaurant#getDateCreation() Restaurant#getDateCreation()}
	 */
	@NotNull
	@PastOrPresent
