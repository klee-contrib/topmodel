...
public class AvisClientRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.AvisClient#getId() AvisClient#getId()}
	 */
	@NotNull
	@Column("avi_id")
	private Integer id;
	...
	/**
	 * Date de l'avis.
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.AvisClient#getDateAvis() AvisClient#getDateAvis()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.AvisClient#getDateCreation() AvisClient#getDateCreation()}
	 */
	@NotNull
	@PastOrPresent
