...
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.AvisClientRead;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.AvisClientWrite;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.ClientItem;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.ClientRead;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.ClientWrite;
...
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.EmployeRead;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.EmployeWrite;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.FactureItem;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.LigneCommandeRead;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.LigneCommandeWrite;
...
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.PaiementItem;
...
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.RestaurantAvecStatistiques;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.RestaurantRead;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.RestaurantWrite;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.StatistiquesRestaurant;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.TableRead;
import restaurant.jpa_jdbc_resttemplate.dtos.restaurant.TableWrite;
...
public class RestaurantMappers {
	 ...
	 */
	public static RestaurantAvecStatistiques createRestaurantAvecStatistiques(Restaurant restaurant, List<Table> tables, Integer nombrePlats, BigDecimal noteMoyenne) {
	 ...
	 */
	public static RestaurantAvecStatistiques mapRestaurantAvecStatistiques(Restaurant restaurant, List<Table> tables, Integer nombrePlats, BigDecimal noteMoyenne, RestaurantAvecStatistiques target) {
		if (target == null) {
			throw new IllegalArgumentException("target cannot be null");
		}
