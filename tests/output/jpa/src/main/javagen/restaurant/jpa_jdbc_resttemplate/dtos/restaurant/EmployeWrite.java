...
import restaurant.jpa_jdbc_resttemplate.enums.restaurant.DepartementCode;
...
public class EmployeWrite implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Employe#getTelephone() Employe#getTelephone()}
	 */
	@Size(max = 20)
	...
	/**
	 * Date de naissance.
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Employe#getDateNaissance() Employe#getDateNaissance()}
	 */
	...
	/**
	 * Date d'embauche.
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Employe#getDateEmbauche() Employe#getDateEmbauche()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_resttemplate.entities.restaurant.Employe#getSalaire() Employe#getSalaire()}
	 */
	@Column("emp_salaire")
