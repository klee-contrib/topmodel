...
public class EmployeWrite implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Employe#getTelephone() Employe#getTelephone()}
	 */
	@Size(max = 20)
	...
	/**
	 * Date de naissance.
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Employe#getDateNaissance() Employe#getDateNaissance()}
	 */
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_enums.dtos.restaurant.EmployeWrite EmployeWrite}.
	 */
	public enum Fields {
		NOM(String.class),
		PRENOM(String.class),
