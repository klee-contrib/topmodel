...
public class RestaurantVersionne implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Restaurant#getId() Restaurant#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Nom du restaurant.
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Restaurant#getNom() Restaurant#getNom()}
	 */
	@NotNull
	@Size(max = 100)
	private String nom;
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Restaurant#getAdresse() Restaurant#getAdresse()}
	 */
	@Size(max = 100)
	...
	/**
	 * Numéro de téléphone.
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Restaurant#getTelephone() Restaurant#getTelephone()}
	 */
	@Size(max = 20)
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Restaurant#getTableClientsRestaurant() Restaurant#getTableClientsRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Restaurant#getPlatsRestaurant() Restaurant#getPlatsRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Restaurant#getAvisClientsRestaurant() Restaurant#getAvisClientsRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Restaurant#getMenusRestaurant() Restaurant#getMenusRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Restaurant#getReservationsRestaurant() Restaurant#getReservationsRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Restaurant#getPromotionsRestaurant() Restaurant#getPromotionsRestaurant()}
	 */
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_enums.dtos.restaurant.RestaurantVersionne RestaurantVersionne}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
