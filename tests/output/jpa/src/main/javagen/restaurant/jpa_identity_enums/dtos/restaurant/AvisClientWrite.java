...
public class AvisClientWrite implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.AvisClient#getClient() AvisClient#getClient()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.AvisClient#getRestaurant() AvisClient#getRestaurant()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_enums.dtos.restaurant.AvisClientWrite AvisClientWrite}.
	 */
	public enum Fields {
		NOTE(Integer.class),
