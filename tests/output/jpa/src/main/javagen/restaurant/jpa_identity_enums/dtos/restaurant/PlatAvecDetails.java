...
public class PlatAvecDetails implements Serializable {
	...
	/**
	 * Identifiant du plat.
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Plat#getId() Plat#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Catégorie du plat.
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Plat#getCategoriePlat() Plat#getCategoriePlat()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Plat#getRestaurant() Plat#getRestaurant()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_enums.dtos.restaurant.PlatAvecDetails PlatAvecDetails}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
