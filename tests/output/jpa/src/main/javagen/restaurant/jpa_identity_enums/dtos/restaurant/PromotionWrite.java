...
public class PromotionWrite implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.Promotion#getRestaurant() Promotion#getRestaurant()}
	 */
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_enums.dtos.restaurant.PromotionWrite PromotionWrite}.
	 */
	public enum Fields {
