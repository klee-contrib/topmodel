...
import restaurant.jpa_identity_enums.entities.restaurant.Reservation;
...
public class ReservationWrite implements Serializable {
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_enums.dtos.restaurant.ReservationWrite ReservationWrite}.
	 */
	public enum Fields {
