...
public class Menu {
	...
	/**
	 * Add a value to {@link restaurant.jpa_identity_enums.entities.restaurant.Menu#menuPlatsMenu menuPlatsMenu}.
	...
	/**
	 * Remove a value from {@link restaurant.jpa_identity_enums.entities.restaurant.Menu#menuPlatsMenu menuPlatsMenu}.
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_enums.entities.restaurant.Menu Menu}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
