...
import restaurant.jpa_identity_enums.entities.restaurant.Restaurant;
...
public class RestaurantAvecStatistiques implements Serializable {
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_enums.dtos.restaurant.RestaurantAvecStatistiques RestaurantAvecStatistiques}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
