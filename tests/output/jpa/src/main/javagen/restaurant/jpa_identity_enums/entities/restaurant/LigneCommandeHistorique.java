...
public class LigneCommandeHistorique {
	 ...
	 * Alias of {@link restaurant.jpa_identity_enums.entities.restaurant.LigneCommande#getId() LigneCommande#getId()}
	 */
	@Id
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_enums.entities.restaurant.LigneCommandeHistorique LigneCommandeHistorique}.
	 */
	public enum Fields {
		ID(Integer.class),
