...
public class ReservationAvecDetails implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.Reservation#getId() Reservation#getId()}
	 */
	@NotNull
	@Column("rev_id")
	private Integer id;
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_uuid_jdbc.dtos.restaurant.ReservationAvecDetails ReservationAvecDetails}.
	 */
	public enum Fields {
		ID(Integer.class),
