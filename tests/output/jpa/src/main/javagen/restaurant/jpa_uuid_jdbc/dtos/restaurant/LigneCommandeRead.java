...
public class LigneCommandeRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.LigneCommande#getId() LigneCommande#getId()}
	 */
	@NotNull
	@Column("lig_id")
	private Integer id;
	...
	/**
	 * Quantité commandée.
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.LigneCommande#getQuantite() LigneCommande#getQuantite()}
	 */
	@NotNull
	@Column("lig_quantite")
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.LigneCommande#getPrixUnitaire() LigneCommande#getPrixUnitaire()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.LigneCommande#getPrixTotal() LigneCommande#getPrixTotal()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.LigneCommande#getCommandeId() LigneCommande#getCommandeId()}
	 */
	@NotNull
	@Column("com_id")
	...
	/**
	 * Plat commandé.
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.LigneCommande#getPlatId() LigneCommande#getPlatId()}
	 */
	@NotNull
	@Column("pla_id")
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_uuid_jdbc.dtos.restaurant.LigneCommandeRead LigneCommandeRead}.
	 */
	public enum Fields {
		ID(Integer.class),
