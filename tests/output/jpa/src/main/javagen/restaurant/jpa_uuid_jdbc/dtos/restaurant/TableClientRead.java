...
public class TableClientRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.TableClient#getId() TableClient#getId()}
	 */
	@NotNull
	@Column("tab_id")
	private Integer id;
	...
	/**
	 * Numéro de la table.
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.TableClient#getNumero() TableClient#getNumero()}
	 */
	@NotNull
	@Size(max = 10)
	@Column("tab_numero")
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.TableClient#getCapacite() TableClient#getCapacite()}
	 */
	@NotNull
	@Column("tab_capacite")
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.TableClient#getDisponible() TableClient#getDisponible()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.TableClient#getRestaurantIdRestaurant() TableClient#getRestaurantIdRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.TableClient#getCommandes() TableClient#getCommandes()}
	 */
	@Column("com_id")
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.TableClient#getReservationsTable() TableClient#getReservationsTable()}
	 */
	@Column("rev_id_table")
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_uuid_jdbc.dtos.restaurant.TableClientRead TableClientRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NUMERO(String.class),
