...
public class PromotionRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.Promotion#getPlatId() Promotion#getPlatId()}
	 */
	@NotNull
	@Column("pla_id")
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.Promotion#getLibelle() Promotion#getLibelle()}
	 */
	@NotNull
	@Size(max = 100)
	@Column("pro_libelle")
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.Promotion#getPourcentageReduction() Promotion#getPourcentageReduction()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.Promotion#getDateDebut() Promotion#getDateDebut()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.Promotion#getDateFin() Promotion#getDateFin()}
	 */
	@NotNull
	@Column("pro_date_fin")
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.Promotion#getActive() Promotion#getActive()}
	 */
	@NotNull
	@Column("pro_active")
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_uuid_jdbc.dtos.restaurant.PromotionRead PromotionRead}.
	 */
	public enum Fields {
