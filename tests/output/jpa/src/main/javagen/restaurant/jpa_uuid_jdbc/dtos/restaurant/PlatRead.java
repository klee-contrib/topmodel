...
public class PlatRead implements Serializable {
	...
	/**
	 * Identifiant du plat.
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.Plat#getId() Plat#getId()}
	 */
	@NotNull
	@Column("pla_id")
	private Integer id;
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_uuid_jdbc.dtos.restaurant.PlatRead PlatRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
