...
public class TableRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_uuid_jdbc.entities.restaurant.TableRestaurant#getId() TableRestaurant#getId()}
	 */
	@NotNull
	@Column("tab_id")
	private Integer id;
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_uuid_jdbc.dtos.restaurant.TableRead TableRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NUMERO(String.class),
