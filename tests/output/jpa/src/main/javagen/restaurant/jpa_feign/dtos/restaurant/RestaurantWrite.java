...
public class RestaurantWrite implements Serializable {
	...
	/**
	 * Nom du restaurant.
	 * Alias of {@link restaurant.jpa_feign.dtos.restaurant.RestaurantRead#getNom() RestaurantRead#getNom()}
	 */
	@NotNull
	@Size(max = 100)
	private String nom;
	 ...
	 * Alias of {@link restaurant.jpa_feign.dtos.restaurant.RestaurantRead#getAdresse() RestaurantRead#getAdresse()}
	 */
	@Size(max = 100)
	...
	/**
	 * Numéro de téléphone.
	 * Alias of {@link restaurant.jpa_feign.dtos.restaurant.RestaurantRead#getTelephone() RestaurantRead#getTelephone()}
	 */
	@Size(max = 20)
	 ...
	 * Alias of {@link restaurant.jpa_feign.dtos.restaurant.RestaurantRead#getMenus() RestaurantRead#getMenus()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.dtos.restaurant.RestaurantRead#getPlats() RestaurantRead#getPlats()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.dtos.restaurant.RestaurantRead#getPromotions() RestaurantRead#getPromotions()}
	 */
	private List<Integer> promotions;

	/**
	 * Association réciproque de AvisClient.Restaurant.
	 * Alias of {@link restaurant.jpa_feign.dtos.restaurant.RestaurantRead#getAvisClients() RestaurantRead#getAvisClients()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.dtos.restaurant.RestaurantRead#getTables() RestaurantRead#getTables()}
	 */
	@Valid
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_feign.dtos.restaurant.RestaurantWrite RestaurantWrite}.
	 */
	public enum Fields {
		NOM(String.class),
