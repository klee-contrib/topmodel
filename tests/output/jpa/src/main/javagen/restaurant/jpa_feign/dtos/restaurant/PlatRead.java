...
public class PlatRead implements Serializable {
	...
	/**
	 * Identifiant du plat.
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.Plat#getId() Plat#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Nom du plat.
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.Plat#getNom() Plat#getNom()}
	 */
	@NotNull
	@Size(max = 100)
	private String nom;
	...
	/**
	 * Description du plat.
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.Plat#getDescription() Plat#getDescription()}
	 */
	@Size(max = 100)
	...
	/**
	 * Prix du plat.
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.Plat#getPrix() Plat#getPrix()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.Plat#getDisponible() Plat#getDisponible()}
	 */
	@NotNull
	...
	/**
	 * Catégorie du plat.
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.Plat#getCategoriePlat() Plat#getCategoriePlat()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.Plat#getRestaurant() Plat#getRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.Plat#getDateCreation() Plat#getDateCreation()}
	 */
	@NotNull
	@PastOrPresent
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_feign.dtos.restaurant.PlatRead PlatRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
