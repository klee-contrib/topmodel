...
public class PromotionRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.Promotion#getPlat() Promotion#getPlat()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.Promotion#getDateCreation() Promotion#getDateCreation()}
	 */
	@NotNull
	@PastOrPresent
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_feign.dtos.restaurant.PromotionRead PromotionRead}.
	 */
	public enum Fields {
