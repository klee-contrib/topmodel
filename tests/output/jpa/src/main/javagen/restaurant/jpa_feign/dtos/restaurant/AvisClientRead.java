...
public class AvisClientRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.AvisClient#getId() AvisClient#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Note sur 5.
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.AvisClient#getNote() AvisClient#getNote()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.AvisClient#getCommentaire() AvisClient#getCommentaire()}
	 */
	@Size(max = 100)
	...
	/**
	 * Date de l'avis.
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.AvisClient#getDateAvis() AvisClient#getDateAvis()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.AvisClient#getApprouve() AvisClient#getApprouve()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.AvisClient#getRestaurant() AvisClient#getRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_feign.entities.restaurant.AvisClient#getDateCreation() AvisClient#getDateCreation()}
	 */
	@NotNull
	@PastOrPresent
