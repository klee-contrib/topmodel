...
public class LigneCommandeHistorique {
	 ...
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.LigneCommande#getDateCreation() LigneCommande#getDateCreation()}
	 */
	@CreatedDate
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_server.entities.restaurant.LigneCommandeHistorique LigneCommandeHistorique}.
	 */
	public enum Fields {
		ID(Integer.class),
