...
import restaurant.jpa_sequence_server.entities.restaurant.CategoriePlat;
...
public class MenuRead implements Serializable {
	...
	/**
	 * Identifiant du menu.
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.Menu#getId() Menu#getId()}
	 */
	@NotNull
	private Integer id;
	 ...
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.Menu#getDateCreation() Menu#getDateCreation()}
	 */
	@NotNull
	@PastOrPresent
