...
public class ReservationRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.Reservation#getId() Reservation#getId()}
	 */
	@NotNull
	private Integer id;
	 ...
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.Reservation#getDateReservation() Reservation#getDateReservation()}
	 */
	@NotNull
	...
	/**
	 * Nombre de personnes.
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.Reservation#getNombrePersonnes() Reservation#getNombrePersonnes()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.Reservation#getCommentaire() Reservation#getCommentaire()}
	 */
	@Size(max = 100)
	 ...
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.Reservation#getConfirmee() Reservation#getConfirmee()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.Reservation#getClient() Reservation#getClient()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.Reservation#getRestaurant() Reservation#getRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.Reservation#getDateCreation() Reservation#getDateCreation()}
	 */
	@NotNull
	@PastOrPresent
	...
	/**
	 * Table réservée.
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.TableRestaurant#getNumero() TableRestaurant#getNumero()}
	 */
	@NotNull
	@Size(max = 10)
	...
	/**
	 * Table réservée.
	 * Alias of {@link restaurant.jpa_sequence_server.entities.restaurant.TableRestaurant#getCapacite() TableRestaurant#getCapacite()}
	 */
	@NotNull
