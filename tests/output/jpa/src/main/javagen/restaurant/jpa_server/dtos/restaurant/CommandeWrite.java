...
public class CommandeWrite implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.CommandeRead#getClient() CommandeRead#getClient()}
	 */
	@Valid
	@NotNull
	...
	/**
	 * Réservation.
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.CommandeRead#getReservation() CommandeRead#getReservation()}
	 */
	@Valid
	 ...
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.CommandeRead#getLignes() CommandeRead#getLignes()}
	 */
	@Valid
	@NotNull
