...
public class RestaurantWrite implements Serializable {
	...
	/**
	 * Nom du restaurant.
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.RestaurantRead#getNom() RestaurantRead#getNom()}
	 */
	@NotNull
	@Size(max = 100)
	private String nom;
	 ...
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.RestaurantRead#getAdresse() RestaurantRead#getAdresse()}
	 */
	@Size(max = 100)
	...
	/**
	 * Numéro de téléphone.
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.RestaurantRead#getTelephone() RestaurantRead#getTelephone()}
	 */
	@Size(max = 20)
	 ...
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.RestaurantRead#getMenus() RestaurantRead#getMenus()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.RestaurantRead#getPlats() RestaurantRead#getPlats()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.RestaurantRead#getPromotions() RestaurantRead#getPromotions()}
	 */
	private List<Integer> promotions;

	/**
	 * Association réciproque de AvisClient.Restaurant.
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.RestaurantRead#getAvisClients() RestaurantRead#getAvisClients()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_server.dtos.restaurant.RestaurantRead#getTables() RestaurantRead#getTables()}
	 */
	@Valid
	@NotNull
