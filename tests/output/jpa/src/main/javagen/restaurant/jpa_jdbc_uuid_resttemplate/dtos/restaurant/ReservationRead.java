...
public class ReservationRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_uuid_resttemplate.entities.restaurant.Reservation#getId() Reservation#getId()}
	 */
	@NotNull
	@Column("rev_id")
	private Integer id;
	 ...
	 * Alias of {@link restaurant.jpa_jdbc_uuid_resttemplate.entities.restaurant.Reservation#getDateCreation() Reservation#getDateCreation()}
	 */
	@NotNull
	@PastOrPresent
