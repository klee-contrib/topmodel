...
public class CommandeHistorique {
	...
	/**
	 * Add a value to {@link restaurant.jpa_sequence_metamodel.entities.restaurant.CommandeHistorique#lignes lignes}.
	...
	/**
	 * Remove a value from {@link restaurant.jpa_sequence_metamodel.entities.restaurant.CommandeHistorique#lignes lignes}.
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.entities.restaurant.CommandeHistorique CommandeHistorique}.
	 */
	public enum Fields {
		ID(Integer.class),
