...
import restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient;
...
public class TableClientRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#getId() TableClient#getId()}
	 */
	@NotNull
	private Integer id;
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#getDisponible() TableClient#getDisponible()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#getRestaurantRestaurant() TableClient#getRestaurantRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#getCommandes() TableClient#getCommandes()}
	 */
	private List<Integer> commandes;

	/**
	 * Association réciproque de Reservation.TableClientIdTable.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#getReservationsTable() TableClient#getReservationsTable()}
	 */
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.dtos.restaurant.TableClientRead TableClientRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NUMERO(String.class),
