...
public class StatistiquesRestaurant implements Serializable {
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.dtos.restaurant.StatistiquesRestaurant StatistiquesRestaurant}.
	 */
	public enum Fields {
		RESTAURANT_ID(Integer.class),
		NOMBRE_COMMANDES(Integer.class),
		CHIFFRE_AFFAIRES(BigDecimal.class),
		NOMBRE_CLIENTS(Integer.class),
