...
import restaurant.jpa_sequence_metamodel.entities.restaurant.Employe;
...
public class EmployeWrite implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Employe#getTelephone() Employe#getTelephone()}
	 */
	@Size(max = 20)
	...
	/**
	 * Date de naissance.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Employe#getDateNaissance() Employe#getDateNaissance()}
	 */
	private LocalDateTime dateNaissance;

	/**
	 * Matricule de l'employé.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Employe#getMatricule() Employe#getMatricule()}
	 */
	@NotNull
	@Size(max = 10)
	...
	/**
	 * Date d'embauche.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Employe#getDateEmbauche() Employe#getDateEmbauche()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Employe#getSalaire() Employe#getSalaire()}
	 */
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.dtos.restaurant.EmployeWrite EmployeWrite}.
	 */
	public enum Fields {
		NOM(String.class),
		PRENOM(String.class),
