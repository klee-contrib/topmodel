...
public class Promotion {
	...
	@SequenceGenerator(sequenceName = "SEQ_PROMOTION", name = "SEQ_PROMOTION", initialValue = 1000, allocationSize = 50)
	private Integer id;
	...
	/**
	 * Add a value to {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Promotion#promotionPlatsPromotion promotionPlatsPromotion}.
	...
	/**
	 * Remove a value from {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Promotion#promotionPlatsPromotion promotionPlatsPromotion}.
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Promotion Promotion}.
	 */
	public enum Fields {
		ID(Integer.class),
