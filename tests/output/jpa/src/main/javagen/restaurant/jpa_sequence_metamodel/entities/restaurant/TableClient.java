...
public class TableClient {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_TABLE_CLIENT")
	@SequenceGenerator(sequenceName = "SEQ_TABLE_CLIENT", name = "SEQ_TABLE_CLIENT", initialValue = 1000, allocationSize = 50)
	private Integer id;
	...
	/**
	 * Add a value to {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#commandes commandes}.
	...
	/**
	 * Add a value to {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#reservationsTable reservationsTable}.
	...
	/**
	 * Remove a value from {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#commandes commandes}.
	...
	/**
	 * Remove a value from {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#reservationsTable reservationsTable}.
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient TableClient}.
	 */
	public enum Fields {
		ID(Integer.class),
		NUMERO(String.class),
