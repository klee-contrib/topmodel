...
public class PlatAvecDetails implements Serializable {
	...
	/**
	 * Identifiant du plat.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Plat#getId() Plat#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Nom du plat.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Plat#getNom() Plat#getNom()}
	 */
	@NotNull
	@Size(max = 100)
	private String nom;
	...
	/**
	 * Description du plat.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Plat#getDescription() Plat#getDescription()}
	 */
	@Size(max = 100)
	...
	/**
	 * Prix du plat.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Plat#getPrix() Plat#getPrix()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Plat#getDisponible() Plat#getDisponible()}
	 */
	@NotNull
	...
	/**
	 * Catégorie du plat.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Plat#getCategoriePlatCategoriePlat() Plat#getCategoriePlatCategoriePlat()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Plat#getRestaurantRestaurant() Plat#getRestaurantRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Plat#getMenuPlatsPlat() Plat#getMenuPlatsPlat()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Plat#getPromotionPlatsPlat() Plat#getPromotionPlatsPlat()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.dtos.restaurant.PlatAvecDetails PlatAvecDetails}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
