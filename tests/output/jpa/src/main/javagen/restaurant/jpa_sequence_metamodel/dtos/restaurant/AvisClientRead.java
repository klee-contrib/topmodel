...
import restaurant.jpa_sequence_metamodel.entities.restaurant.AvisClient;
...
public class AvisClientRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.AvisClient#getId() AvisClient#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Note sur 5.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.AvisClient#getNote() AvisClient#getNote()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.AvisClient#getCommentaire() AvisClient#getCommentaire()}
	 */
	@Size(max = 100)
	...
	/**
	 * Date de l'avis.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.AvisClient#getDateAvis() AvisClient#getDateAvis()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.AvisClient#getApprouve() AvisClient#getApprouve()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.AvisClient#getNombreVues() AvisClient#getNombreVues()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.dtos.restaurant.AvisClientRead AvisClientRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOTE(Integer.class),
