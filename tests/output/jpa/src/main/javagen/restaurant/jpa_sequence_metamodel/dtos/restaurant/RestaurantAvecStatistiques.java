...
import restaurant.jpa_sequence_metamodel.entities.restaurant.Restaurant;
...
public class RestaurantAvecStatistiques implements Serializable {
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.dtos.restaurant.RestaurantAvecStatistiques RestaurantAvecStatistiques}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
