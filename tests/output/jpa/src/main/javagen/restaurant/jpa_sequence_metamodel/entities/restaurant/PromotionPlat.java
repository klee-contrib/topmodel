...
public class PromotionPlat {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_PROMOTION_PLAT")
	@SequenceGenerator(sequenceName = "SEQ_PROMOTION_PLAT", name = "SEQ_PROMOTION_PLAT", initialValue = 1000, allocationSize = 50)
	private Integer id;
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.entities.restaurant.PromotionPlat PromotionPlat}.
	 */
	public enum Fields {
		ID(Integer.class),
