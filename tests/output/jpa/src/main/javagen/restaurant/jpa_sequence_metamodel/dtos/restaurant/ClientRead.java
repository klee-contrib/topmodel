...
import restaurant.jpa_sequence_metamodel.entities.restaurant.Client;
...
public class ClientRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Client#getId() Client#getId()}
	 */
	@NotNull
	private Integer id;
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Client#getAvisClientsClient() Client#getAvisClientsClient()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Client#getReservationsClient() Client#getReservationsClient()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.dtos.restaurant.ClientRead ClientRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
