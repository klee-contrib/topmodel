...
import restaurant.jpa_sequence_metamodel.entities.restaurant.Table;
...
public class TableWrite implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Table#getDisponible() Table#getDisponible()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Table#getRestaurant() Table#getRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Table#getCommandes() Table#getCommandes()}
	 */
	private List<Integer> commandes;

	/**
	 * Association réciproque de Reservation.TableId.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Table#getReservations() Table#getReservations()}
	 */
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.dtos.restaurant.TableWrite TableWrite}.
	 */
	public enum Fields {
		NUMERO(String.class),
