...
public class ReservationAvecDetails implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Reservation#getId() Reservation#getId()}
	 */
	@NotNull
	private Integer id;
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Reservation#getDateReservation() Reservation#getDateReservation()}
	 */
	@NotNull
	...
	/**
	 * Nombre de personnes.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Reservation#getNombrePersonnes() Reservation#getNombrePersonnes()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Reservation#getCommentaire() Reservation#getCommentaire()}
	 */
	@Size(max = 100)
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Reservation#getConfirmee() Reservation#getConfirmee()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Reservation#getClientClient() Reservation#getClientClient()}
	 */
	@NotNull
	...
	/**
	 * Table réservée.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Reservation#getTableClientTable() Reservation#getTableClientTable()}
	 */
	private Integer tableClientIdTable;

	/**
	 * Restaurant concerné par la réservation.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Reservation#getRestaurantRestaurant() Reservation#getRestaurantRestaurant()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Client#getNom() Client#getNom()}
	 */
	@NotNull
	@Size(max = 100)
	...
	/**
	 * Informations du client ayant fait la réservation.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Client#getPrenom() Client#getPrenom()}
	 */
	@NotNull
	@Size(max = 100)
	...
	/**
	 * Informations du client ayant fait la réservation.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Client#getTelephone() Client#getTelephone()}
	 */
	@Size(max = 20)
	...
	/**
	 * Table réservée.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#getNumero() TableClient#getNumero()}
	 */
	@NotNull
	@Size(max = 10)
	...
	/**
	 * Table réservée.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.TableClient#getCapacite() TableClient#getCapacite()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_sequence_metamodel.dtos.restaurant.ReservationAvecDetails ReservationAvecDetails}.
	 */
	public enum Fields {
		ID(Integer.class),
