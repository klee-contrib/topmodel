...
public class ReservationAvecDetails implements Serializable {
	...
	/**
	 * Table réservée.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Table#getNumero() Table#getNumero()}
	 */
	@NotNull
	@Size(max = 10)
	...
	/**
	 * Table réservée.
	 * Alias of {@link restaurant.jpa_sequence_metamodel.entities.restaurant.Table#getCapacite() Table#getCapacite()}
	 */
	@NotNull
