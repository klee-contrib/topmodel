...
public class EmployeWrite implements Serializable {
	...
	/**
	 * Date de naissance.
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.Employe#getDateNaissance() Employe#getDateNaissance()}
	 */
	...
	/**
	 * Date d'embauche.
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.Employe#getDateEmbauche() Employe#getDateEmbauche()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.Employe#getSalaire() Employe#getSalaire()}
	 */
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_feign.dtos.restaurant.EmployeWrite EmployeWrite}.
	 */
	public enum Fields {
		NOM(String.class),
		PRENOM(String.class),
