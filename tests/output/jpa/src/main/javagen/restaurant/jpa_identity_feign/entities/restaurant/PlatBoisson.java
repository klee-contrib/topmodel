...
public class PlatBoisson extends Plat {
	 ...
	 */
	@Column(name = "VOLUME", nullable = false, columnDefinition = "int")
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_feign.entities.restaurant.PlatBoisson PlatBoisson}.
	 */
	public enum Fields {
