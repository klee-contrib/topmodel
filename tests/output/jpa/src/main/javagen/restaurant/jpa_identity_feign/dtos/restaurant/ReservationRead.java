...
public class ReservationRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.Reservation#getId() Reservation#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_feign.dtos.restaurant.ReservationRead ReservationRead}.
	 */
	public enum Fields {
		ID(Integer.class),
