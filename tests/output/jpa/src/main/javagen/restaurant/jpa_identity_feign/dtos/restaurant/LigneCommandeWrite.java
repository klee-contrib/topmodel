...
public class LigneCommandeWrite implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.LigneCommande#getCommande() LigneCommande#getCommande()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_feign.dtos.restaurant.LigneCommandeWrite LigneCommandeWrite}.
	 */
	public enum Fields {
