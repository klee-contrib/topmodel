...
public class Menu {
	...
	/**
	 * Add a value to {@link restaurant.jpa_identity_feign.entities.restaurant.Menu#plats plats}.
	...
	/**
	 * Remove a value from {@link restaurant.jpa_identity_feign.entities.restaurant.Menu#plats plats}.
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_feign.entities.restaurant.Menu Menu}.
	 */
	public enum Fields {
		ID(Integer.class),
		NOM(String.class),
