...
public class PromotionWrite implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.Promotion#getLibelle() Promotion#getLibelle()}
	 */
	@NotNull
	@Size(max = 100)
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.Promotion#getPourcentageReduction() Promotion#getPourcentageReduction()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.Promotion#getDateDebut() Promotion#getDateDebut()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.Promotion#getDateFin() Promotion#getDateFin()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.Promotion#getActive() Promotion#getActive()}
	 */
	@NotNull
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_feign.dtos.restaurant.PromotionWrite PromotionWrite}.
	 */
	public enum Fields {
