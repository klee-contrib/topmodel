...
public class TableRead implements Serializable {
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.TableRestaurant#getId() TableRestaurant#getId()}
	 */
	@NotNull
	private Integer id;
	...
	/**
	 * Numéro de la table.
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.TableRestaurant#getNumero() TableRestaurant#getNumero()}
	 */
	@NotNull
	@Size(max = 10)
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.TableRestaurant#getCapacite() TableRestaurant#getCapacite()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.TableRestaurant#getDisponible() TableRestaurant#getDisponible()}
	 */
	@NotNull
	 ...
	 * Alias of {@link restaurant.jpa_identity_feign.entities.restaurant.TableRestaurant#getDateCreation() TableRestaurant#getDateCreation()}
	 */
	@NotNull
	@PastOrPresent
	...
	/**
	 * Enumération des champs de la classe {@link restaurant.jpa_identity_feign.dtos.restaurant.TableRead TableRead}.
	 */
	public enum Fields {
		ID(Integer.class),
		NUMERO(String.class),
