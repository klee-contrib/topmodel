...
export type CommandeAuditee = EntityToType<CommandeAuditeeEntityType>;
export type CommandeAuditeeEntityType = typeof CommandeAuditeeEntity;

export const CommandeAuditeeEntity = entity({
