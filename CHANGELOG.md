...
- Les définitions de clés d'unicité et de valeurs de références utilisent désormais des références de propriétés, comme on utilise déjà par ailleurs pour les alias par exemple. Cela permet de remonter également les erreurs de résolution de propriétés directement dans l'IDE au bon endroit, et d'avoir de l'autocomplétion sur les noms de propriétés.
