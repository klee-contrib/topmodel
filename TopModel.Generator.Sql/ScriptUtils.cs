...
public static class ScriptUtils
{
    ...
    public static string GetInsertLine(this SqlConfig config, Class classe, ClassValue refValue)
    {
        ...
        {
            var insertValue = GetInsertValue(config, classe, property, refValue);
            if (insertValue != null)
            {
                properties[property.SqlName] = insertValue;
            }
        }
    ...
    private static string? GetInsertValue(SqlConfig config, Class classe, IProperty property, ClassValue refValue)
    {
        if (
        ...
        if (property.AutoGeneratedValue && property.PrimaryKey)
        {
            return config.UsesSequence(classe) ? config.GetNextValCall(classe) : null;
        }
        ...
        return property.AutoGeneratedValue ? null : "NULL";
    }
