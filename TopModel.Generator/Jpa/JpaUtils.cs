...
public static class JpaUtils
{
    ...
    public static bool IsEnum(this IFieldProperty rp)
    {
        return rp.Class != null
            ...
            && rp.Class.ReferenceValues.Any()
            && rp.Class.ReferenceValues.All(r => r.Value.ContainsKey(rp))
            && rp.Class.PrimaryKey.Count() <= 1
            && (rp.PrimaryKey || rp.Class.Properties.OfType<IFieldProperty>().Count() == 1)
            && rp.Class.ReferenceValues.All(r => !Regex.IsMatch(r.Value[rp].ToString() ?? string.Empty, "(?<=[^$\\w'\"\\])(?!(abstract|assert|boolean|break|byte|case|catch|char|class|const|continue|default|double|do|else|enum|extends|false|final|finally|float|for|goto|if|implements|import|instanceof|int|interface|long|native|new|null|package|private|protected|public|return|short|static|strictfp|super|switch|synchronized|this|throw|throws|transient|true|try|void|volatile|while|_\\b))([A-Za-z_$][$\\w]*)"));
    }
