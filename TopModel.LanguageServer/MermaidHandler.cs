    ...
    public static string GenerateDiagramFile(ModelFile file)
    {
        ...
        foreach (var classe in classes)
        {
            ...
            if (classe.Reference && classe.ReferenceValues.Any())
            {
                ...
                {
                    var code = !classe.PrimaryKey.Any() || !classe.PrimaryKey.Single().Domain.AutoGeneratedValue
                        ? refValue.Value[classe.PrimaryKey.SingleOrDefault() ?? classe.Properties.OfType<IFieldProperty>().First()]
