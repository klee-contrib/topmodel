...
namespace Kinetix.NewGenerator.Javascript
{
    ...
    public static class JavascriptResourceGenerator
    {
        ...
        /// <param name="classes">Liste des classes.</param>
        public static void Generate(JavascriptConfig config, IList<Class> classes)
        {
            ...
            {
                var dirInfo = Directory.CreateDirectory(config.ResourceOutputDirectory);
