...
namespace Kinetix.NewGenerator.ProceduralSql
{
    ...
    public abstract class AbstractSchemaGenerator
    {
        ...
        public void GenerateListInitScript(Dictionary<Class, IEnumerable<ReferenceValue>> initDictionary, bool isStatic)
        {
        ...
        public void GenerateSchemaScript(ICollection<Class> classes)
        {
        ...
        private static IEnumerable<Class> OrderStaticTableList(Dictionary<Class, IEnumerable<ReferenceValue>> dictionnary)
        {
