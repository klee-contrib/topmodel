...
public abstract class ClassGeneratorBase<T>(ILogger<ClassGeneratorBase<T>> logger, IFileWriterProvider writerProvider) : GeneratorBase<T>(logger, writerProvider)
