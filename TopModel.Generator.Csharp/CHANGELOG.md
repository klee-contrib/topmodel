...
- [`6c99eab`](https://github.com/klee-contrib/topmodel/commit/6c99eab393440838ade979c057e2502b8795ed1a) - `i18n.allowPropertyLabelFallback`, pour uniformiser le fallback du label vers le nom
  ...
  **impact génération** : Les générateurs de traductions de propriétés (dans le DbContext ou en ResX) incluent désormais par défaut toutes les propriétés, même celles qui n'ont pas de libellé en utilisant leur nom à la place. Il s'agit du même comportement que celui qu'à toujours eu le générateur JS équivalent.
